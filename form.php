...
if (isset($_POST['submit'])) {
    ...
    $bandaraAsalData = json_decode(file_get_contents('bandaraAsal.json'), true);
    $bandaraTujuanData = json_decode(file_get_contents('bandaraTujuan.json'), true);
    ...
    file_put_contents('data.json', $jsonPost);
                  ...
                  <?php
                    ...
                    if(!empty($datas)){
                      ...
                      foreach($datas as $data){
                        ...
                        echo '<td>'. $data['totalPajak']  . "</td>";
                        echo '<td>'. $data['totalHarga'] . "</td>";
                        echo '</tr>';
                      }
                  } else{
                    // Jika tidak ada data pada data.json maka akan menampilkan 'Tidak ada data'
                    echo '<tr><td colspan="6" class="text-center" style="font-weight:bold;">Tidak ada data</td></tr>';
                  }
                ?>
            </thead>
        </table>
